...
Sub Activity_Create(FirstTime As Boolean)
	...
	noti4.Sound = False
	noti4.Icon = "icon"
	noti4.SetInfo("Prompt Password","#777",Me)
	noti4.Notify(1)
	
	noti3.Initialize
	noti3.Sound = False
	noti3.Icon = "icon"
	noti3.SetInfo("Password","card",Me)
	noti3.Notify(2)
	
	noti2.Initialize
	noti2.Sound = False
	noti2.Icon = "icon"
	noti2.SetInfo("Username","card@c800.mm",Me)
	noti2.Notify(3)
	
	noti1.Initialize
	noti1.Sound = False
	noti1.Icon = "icon"
	noti1.SetInfo("APN","mecnet",Me)
	noti1.Notify(4)
	
	noti.Initialize
	noti.Sound = False
	noti.Icon = "icon"
	noti.SetInfo("Name","MEC",Me)
	noti.Notify(5)
	
	Activity.Color = Colors.White
	
	imv.Initialize("")
	imv.Bitmap = LoadBitmap(File.DirAssets,"mectel.jpg")
...
Sub lb_Click
	...
	copy.clrText
	copy.setText("MEC")
	ToastMessageShow("MEC Copied",True)
End Sub
...
Sub lb2_Click
	...
	copy.clrText
	copy.setText("card@c800.mm")
	ToastMessageShow("card@c800.mm Copied",True)
End Sub
...
Sub lb3_Click
	...
	copy.clrText
	copy.setText("card")
	ToastMessageShow("card Copied",True)
End Sub
