...
Sub Activity_Create(FirstTime As Boolean)
	...
	noti.Sound = False
	noti.Icon = "icon"
	noti.SetInfo("Name","Telenor",Me)
	noti.Notify(2)
	
	Activity.Color = Colors.White
	
	imv.Initialize("")
	imv.Bitmap = LoadBitmap(File.DirAssets,"telenor.png")
	imv.Gravity = Gravity.FILL
	Activity.AddView(imv,50%x - 50dip,10dip,100dip,100dip)
	
lb.Initialize("lb")
lb.Text = "Name : Telenor"
...
Sub lb_Click
	...
	copy.clrText
	copy.setText("Telenor")
	ToastMessageShow("Telenor Copied",True)
End Sub
