...
public class ooredoo extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmanps", "com.htetznaing.mmanps.ooredoo");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmanps", "com.htetznaing.mmanps.ooredoo");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmanps.ooredoo", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._noti1.SetInfo(processBA,"APN","Internet",ooredoo.getObject());
...
mostCurrent._noti.setIcon("icon");
 //BA.debugLineNum = 63;BA.debugLine="noti.SetInfo(\"Name\",\"Ooredoo\",Me)";
mostCurrent._noti.SetInfo(processBA,"Name","Ooredoo",ooredoo.getObject());
...
mostCurrent._imv.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 69;BA.debugLine="imv.Bitmap = LoadBitmap(File.DirAssets,\"ooredoo.p";
mostCurrent._imv.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ooredoo.png").getObject()));
...
mostCurrent._lb.Initialize(mostCurrent.activityBA,"lb");
 //BA.debugLineNum = 74;BA.debugLine="lb.Text = \"Name : Ooredoo\"";
mostCurrent._lb.setText((Object)("Name : Ooredoo"));
...
mostCurrent._lb.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 76;BA.debugLine="Activity.AddView(lb,0%x,(imv.Top+imv.Height)+2%y,";
...
mostCurrent._noti.setIcon("icon");
 //BA.debugLineNum = 125;BA.debugLine="noti.SetInfo(\"Name\",\"Ooredoo\",Me)";
mostCurrent._noti.SetInfo(processBA,"Name","Ooredoo",ooredoo.getObject());
...
public static String  _lb_click() throws Exception{
 //BA.debugLineNum = 93;BA.debugLine="Sub lb_Click";
 //BA.debugLineNum = 94;BA.debugLine="lb.SetTextColorAnimated(1000,Colors.Green)";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 96;BA.debugLine="copy.setText(\"Ooredoo\")";
mostCurrent._copy.setText(mostCurrent.activityBA,"Ooredoo");
 //BA.debugLineNum = 97;BA.debugLine="ToastMessageShow(\"Ooredoo Copied\",True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Ooredoo Copied",anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 98;BA.debugLine="End Sub";
return "";
}
public static String  _lb1_click() throws Exception{
 //BA.debugLineNum = 100;BA.debugLine="Sub lb1_Click";
