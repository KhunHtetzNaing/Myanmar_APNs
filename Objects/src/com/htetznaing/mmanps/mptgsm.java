...
public class mptgsm extends Activity implements B4AActivity{
	public static mptgsm mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmanps", "com.htetznaing.mmanps.mptgsm");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (mptgsm).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmanps", "com.htetznaing.mmanps.mptgsm");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmanps.mptgsm", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (mptgsm) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (mptgsm) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (mptgsm) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
mostCurrent._ph.SetScreenOrientation(processBA,(int) (1));
 //BA.debugLineNum = 30;BA.debugLine="Activity.LoadLayout(\"Lay1\")";
mostCurrent._activity.LoadLayout("Lay1",mostCurrent.activityBA);
 //BA.debugLineNum = 31;BA.debugLine="fb.Icon = res.GetDrawable(\"ic_add_white_24dp\")";
mostCurrent._fb.setIcon(mostCurrent._res.GetDrawable("ic_add_white_24dp"));
 //BA.debugLineNum = 32;BA.debugLine="fb.HideOffset = 100%y - fb.Top";
mostCurrent._fb.setHideOffset((int) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._fb.getTop()));
 //BA.debugLineNum = 33;BA.debugLine="fb.Hide(False)";
mostCurrent._fb.Hide(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 34;BA.debugLine="fb.Show(True)";
mostCurrent._fb.Show(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 36;BA.debugLine="fb1.Icon = res.GetDrawable(\"about\")";
mostCurrent._fb1.setIcon(mostCurrent._res.GetDrawable("about"));
 //BA.debugLineNum = 37;BA.debugLine="fb1.HideOffset = 100%y - fb.Top";
mostCurrent._fb1.setHideOffset((int) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._fb.getTop()));
 //BA.debugLineNum = 38;BA.debugLine="fb1.Hide(False)";
mostCurrent._fb1.Hide(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 39;BA.debugLine="fb1.Show(True)";
mostCurrent._fb1.Show(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 41;BA.debugLine="ToastMessageShow(\"You can see APN in Notification";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("You can see APN in Notification!",anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 43;BA.debugLine="noti4.Initialize";
mostCurrent._noti4.Initialize();
 //BA.debugLineNum = 44;BA.debugLine="noti4.Sound = False";
mostCurrent._noti4.setSound(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 45;BA.debugLine="noti4.Icon = \"icon\"";
mostCurrent._noti4.setIcon("icon");
 //BA.debugLineNum = 46;BA.debugLine="noti4.SetInfo(\"APN Protocol\",\"IPV4\",Me)";
mostCurrent._noti4.SetInfo(processBA,"APN Protocol","IPV4",mptgsm.getObject());
 //BA.debugLineNum = 47;BA.debugLine="noti4.Notify(1)";
mostCurrent._noti4.Notify((int) (1));
 //BA.debugLineNum = 49;BA.debugLine="noti3.Initialize";
mostCurrent._noti3.Initialize();
 //BA.debugLineNum = 50;BA.debugLine="noti3.Sound = False";
mostCurrent._noti3.setSound(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 51;BA.debugLine="noti3.Icon = \"icon\"";
mostCurrent._noti3.setIcon("icon");
 //BA.debugLineNum = 52;BA.debugLine="noti3.SetInfo(\"MNC\",\"01\",Me)";
mostCurrent._noti3.SetInfo(processBA,"MNC","01",mptgsm.getObject());
 //BA.debugLineNum = 53;BA.debugLine="noti3.Notify(2)";
mostCurrent._noti3.Notify((int) (2));
 //BA.debugLineNum = 55;BA.debugLine="noti2.Initialize";
mostCurrent._noti2.Initialize();
 //BA.debugLineNum = 56;BA.debugLine="noti2.Sound = False";
mostCurrent._noti2.setSound(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 57;BA.debugLine="noti2.Icon = \"icon\"";
mostCurrent._noti2.setIcon("icon");
 //BA.debugLineNum = 58;BA.debugLine="noti2.SetInfo(\"MCC\",\"414\",Me)";
mostCurrent._noti2.SetInfo(processBA,"MCC","414",mptgsm.getObject());
 //BA.debugLineNum = 59;BA.debugLine="noti2.Notify(3)";
mostCurrent._noti2.Notify((int) (3));
 //BA.debugLineNum = 61;BA.debugLine="noti1.Initialize";
mostCurrent._noti1.Initialize();
 //BA.debugLineNum = 62;BA.debugLine="noti1.Sound = False";
mostCurrent._noti1.setSound(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 63;BA.debugLine="noti1.Icon = \"icon\"";
mostCurrent._noti1.setIcon("icon");
 //BA.debugLineNum = 64;BA.debugLine="noti1.SetInfo(\"APN\",\"mptnet\",Me)";
mostCurrent._noti1.SetInfo(processBA,"APN","mptnet",mptgsm.getObject());
 //BA.debugLineNum = 65;BA.debugLine="noti1.Notify(4)";
mostCurrent._noti1.Notify((int) (4));
 //BA.debugLineNum = 67;BA.debugLine="noti.Initialize";
mostCurrent._noti.Initialize();
 //BA.debugLineNum = 68;BA.debugLine="noti.Sound = False";
mostCurrent._noti.setSound(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 69;BA.debugLine="noti.Icon = \"icon\"";
mostCurrent._noti.setIcon("icon");
 //BA.debugLineNum = 70;BA.debugLine="noti.SetInfo(\"Name\",\"MPT\",Me)";
mostCurrent._noti.SetInfo(processBA,"Name","MPT",mptgsm.getObject());
 //BA.debugLineNum = 71;BA.debugLine="noti.Notify(5)";
...
mostCurrent._activity.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 75;BA.debugLine="imv.Initialize(\"\")";
mostCurrent._imv.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 76;BA.debugLine="imv.Bitmap = LoadBitmap(File.DirAssets,\"mpt.png\")";
mostCurrent._imv.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"mpt.png").getObject()));
 //BA.debugLineNum = 77;BA.debugLine="imv.Gravity = Gravity.FILL";
mostCurrent._imv.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 78;BA.debugLine="Activity.AddView(imv,50%x - 50dip,10dip,100dip,10";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._imv.getObject()),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (50),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (100)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (100)));
 //BA.debugLineNum = 80;BA.debugLine="lb.Initialize(\"lb\")";
mostCurrent._lb.Initialize(mostCurrent.activityBA,"lb");
 //BA.debugLineNum = 81;BA.debugLine="lb.Text = \"Name : MPT\"";
mostCurrent._lb.setText((Object)("Name : MPT"));
 //BA.debugLineNum = 82;BA.debugLine="lb.TextColor = Colors.Black";
mostCurrent._lb.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 83;BA.debugLine="Activity.AddView(lb,0%x,(imv.Top+imv.Height)+2%y,";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._lb.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA),(int) ((mostCurrent._imv.getTop()+mostCurrent._imv.getHeight())+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 84;BA.debugLine="lb.Gravity = Gravity.CENTER";
mostCurrent._lb.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 86;BA.debugLine="lb1.Initialize(\"lb1\")";
mostCurrent._lb1.Initialize(mostCurrent.activityBA,"lb1");
 //BA.debugLineNum = 87;BA.debugLine="lb1.Text = \"APN : mptnet\"";
mostCurrent._lb1.setText((Object)("APN : mptnet"));
 //BA.debugLineNum = 88;BA.debugLine="lb1.TextColor = Colors.Black";
mostCurrent._lb1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 89;BA.debugLine="Activity.AddView(lb1,0%x,(lb.Top+lb.Height),100%x";
...
mostCurrent._lb1.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 92;BA.debugLine="lb2.Initialize(\"lb2\")";
mostCurrent._lb2.Initialize(mostCurrent.activityBA,"lb2");
 //BA.debugLineNum = 93;BA.debugLine="lb2.Text = \"MCC : 414\"";
mostCurrent._lb2.setText((Object)("MCC : 414"));
 //BA.debugLineNum = 94;BA.debugLine="lb2.TextColor = Colors.Black";
mostCurrent._lb2.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 95;BA.debugLine="Activity.AddView(lb2,0%x,(lb1.Top+lb1.Height),100";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._lb2.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA),(int) ((mostCurrent._lb1.getTop()+mostCurrent._lb1.getHeight())),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 96;BA.debugLine="lb2.Gravity = Gravity.CENTER";
mostCurrent._lb2.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 98;BA.debugLine="lb3.Initialize(\"lb3\")";
mostCurrent._lb3.Initialize(mostCurrent.activityBA,"lb3");
 //BA.debugLineNum = 99;BA.debugLine="lb3.Text = \"MNC : 01\"";
mostCurrent._lb3.setText((Object)("MNC : 01"));
 //BA.debugLineNum = 100;BA.debugLine="lb3.TextColor = Colors.Black";
mostCurrent._lb3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 101;BA.debugLine="Activity.AddView(lb3,0%x,(lb2.Top+lb2.Height),100";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._lb3.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA),(int) ((mostCurrent._lb2.getTop()+mostCurrent._lb2.getHeight())),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 102;BA.debugLine="lb3.Gravity = Gravity.CENTER";
mostCurrent._lb3.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 104;BA.debugLine="lb4.Initialize(\"lb4\")";
mostCurrent._lb4.Initialize(mostCurrent.activityBA,"lb4");
 //BA.debugLineNum = 105;BA.debugLine="lb4.Text = \"APN Protocol : IPV4\"";
mostCurrent._lb4.setText((Object)("APN Protocol : IPV4"));
 //BA.debugLineNum = 106;BA.debugLine="lb4.TextColor = Colors.Black";
mostCurrent._lb4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 107;BA.debugLine="Activity.AddView(lb4,0%x,(lb3.Top+lb3.Height),100";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._lb4.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA),(int) ((mostCurrent._lb3.getTop()+mostCurrent._lb3.getHeight())),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 108;BA.debugLine="lb4.Gravity = Gravity.CENTER";
mostCurrent._lb4.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 110;BA.debugLine="bbg.Initialize(Colors.Black , 15)";
mostCurrent._bbg.Initialize(anywheresoftware.b4a.keywords.Common.Colors.Black,(int) (15));
 //BA.debugLineNum = 111;BA.debugLine="b.Initialize(\"b\")";
mostCurrent._b.Initialize(mostCurrent.activityBA,"b");
 //BA.debugLineNum = 112;BA.debugLine="b.Text = \"Start\"";
mostCurrent._b.setText((Object)("Start"));
 //BA.debugLineNum = 113;BA.debugLine="b.Background = bbg";
mostCurrent._b.setBackground((android.graphics.drawable.Drawable)(mostCurrent._bbg.getObject()));
 //BA.debugLineNum = 114;BA.debugLine="Activity.AddView(b,20%x,(lb4.Top+lb4.Height)+2%y,";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._b.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),(int) ((mostCurrent._lb4.getTop()+mostCurrent._lb4.getHeight())+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (60),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)));
 //BA.debugLineNum = 116;BA.debugLine="Banner.Initialize(\"Banner\",\" ca-app-pub-417334857";
...
mostCurrent._banner.LoadAd();
 //BA.debugLineNum = 118;BA.debugLine="Activity.AddView(Banner,0%x,100%y - 80dip,100%x,5";
...
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 125;BA.debugLine="ad2.Initialize(\"ad2\",15000)";
...
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_intent.getObject()));
 //BA.debugLineNum = 172;BA.debugLine="noti4.Initialize";
mostCurrent._noti4.Initialize();
 //BA.debugLineNum = 173;BA.debugLine="noti4.Sound = False";
mostCurrent._noti4.setSound(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 174;BA.debugLine="noti4.Icon = \"icon\"";
mostCurrent._noti4.setIcon("icon");
 //BA.debugLineNum = 175;BA.debugLine="noti4.SetInfo(\"APN Protocol\",\"IPV4\",Me)";
mostCurrent._noti4.SetInfo(processBA,"APN Protocol","IPV4",mptgsm.getObject());
 //BA.debugLineNum = 176;BA.debugLine="noti4.Notify(1)";
mostCurrent._noti4.Notify((int) (1));
 //BA.debugLineNum = 178;BA.debugLine="noti3.Initialize";
mostCurrent._noti3.Initialize();
 //BA.debugLineNum = 179;BA.debugLine="noti3.Sound = False";
mostCurrent._noti3.setSound(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 180;BA.debugLine="noti3.Icon = \"icon\"";
mostCurrent._noti3.setIcon("icon");
 //BA.debugLineNum = 181;BA.debugLine="noti3.SetInfo(\"MNC\",\"01\",Me)";
mostCurrent._noti3.SetInfo(processBA,"MNC","01",mptgsm.getObject());
 //BA.debugLineNum = 182;BA.debugLine="noti3.Notify(2)";
mostCurrent._noti3.Notify((int) (2));
 //BA.debugLineNum = 184;BA.debugLine="noti2.Initialize";
mostCurrent._noti2.Initialize();
 //BA.debugLineNum = 185;BA.debugLine="noti2.Sound = False";
mostCurrent._noti2.setSound(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 186;BA.debugLine="noti2.Icon = \"icon\"";
mostCurrent._noti2.setIcon("icon");
 //BA.debugLineNum = 187;BA.debugLine="noti2.SetInfo(\"MCC\",\"414\",Me)";
mostCurrent._noti2.SetInfo(processBA,"MCC","414",mptgsm.getObject());
 //BA.debugLineNum = 188;BA.debugLine="noti2.Notify(3)";
mostCurrent._noti2.Notify((int) (3));
 //BA.debugLineNum = 190;BA.debugLine="noti1.Initialize";
mostCurrent._noti1.Initialize();
 //BA.debugLineNum = 191;BA.debugLine="noti1.Sound = False";
mostCurrent._noti1.setSound(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 192;BA.debugLine="noti1.Icon = \"icon\"";
mostCurrent._noti1.setIcon("icon");
 //BA.debugLineNum = 193;BA.debugLine="noti1.SetInfo(\"APN\",\"mptnet\",Me)";
mostCurrent._noti1.SetInfo(processBA,"APN","mptnet",mptgsm.getObject());
 //BA.debugLineNum = 194;BA.debugLine="noti1.Notify(4)";
mostCurrent._noti1.Notify((int) (4));
 //BA.debugLineNum = 196;BA.debugLine="noti.Initialize";
mostCurrent._noti.Initialize();
 //BA.debugLineNum = 197;BA.debugLine="noti.Sound = False";
mostCurrent._noti.setSound(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 198;BA.debugLine="noti.Icon = \"icon\"";
mostCurrent._noti.setIcon("icon");
 //BA.debugLineNum = 199;BA.debugLine="noti.SetInfo(\"Name\",\"MPT\",Me)";
mostCurrent._noti.SetInfo(processBA,"Name","MPT",mptgsm.getObject());
 //BA.debugLineNum = 200;BA.debugLine="noti.Notify(5)";
mostCurrent._noti.Notify((int) (5));
...
mostCurrent._ph = new anywheresoftware.b4a.phone.Phone();
 //BA.debugLineNum = 22;BA.debugLine="Dim Banner As AdView";
mostCurrent._banner = new anywheresoftware.b4a.admobwrapper.AdViewWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Dim Interstitial As InterstitialAd";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 132;BA.debugLine="copy.setText(\"MPT\")";
mostCurrent._copy.setText(mostCurrent.activityBA,"MPT");
 //BA.debugLineNum = 133;BA.debugLine="ToastMessageShow(\"MPT Copied\",True)";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 139;BA.debugLine="copy.setText(\"mpnet\")";
mostCurrent._copy.setText(mostCurrent.activityBA,"mpnet");
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 146;BA.debugLine="copy.setText(\"414\")";
mostCurrent._copy.setText(mostCurrent.activityBA,"414");
 //BA.debugLineNum = 147;BA.debugLine="ToastMessageShow(\"414 Copied\",True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("414 Copied",anywheresoftware.b4a.keywords.Common.True);
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 153;BA.debugLine="copy.setText(\"01\")";
mostCurrent._copy.setText(mostCurrent.activityBA,"01");
 //BA.debugLineNum = 154;BA.debugLine="ToastMessageShow(\"01 Copied\",True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("01 Copied",anywheresoftware.b4a.keywords.Common.True);
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 160;BA.debugLine="copy.setText(\"IPV4\")";
mostCurrent._copy.setText(mostCurrent.activityBA,"IPV4");
 //BA.debugLineNum = 161;BA.debugLine="ToastMessageShow(\"IPV4 Copied\",True)";
